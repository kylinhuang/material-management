...
@RestController
@RequestMapping("/warehousingSuppliesOutRecord")
public class WarehousingSuppliesOutRecordController {


    @Autowired
    private WarehousingSupplierOutRecordService warehousingSupplierOutRecordService;
    ...
    public ResponseBean allList(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
        ...
        PageVO<WarehousingSupplierOutRecordVO> supplierVOPageVO = warehousingSupplierOutRecordService.allList(pageNum, pageSize, warehousingSupplierReq);
    ...
    public ResponseBean list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                             @RequestParam(value = "pageSize") Integer pageSize,
                             WarehousingSupplierReq warehousingSupplierReq) {
        PageVO<WarehousingSupplierOutRecordVO> supplierVOPageVO = warehousingSupplierOutRecordService.list(pageNum, pageSize, warehousingSupplierReq);
        return ResponseBean.success(supplierVOPageVO);
    }
