...
//        }
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "物资提交审核失败", operation = "物资提交审核")
    @ApiOperation(value = "物资提交审核", notes = "物资提交审核")
    @RequiresPermissions({"product:review"})
    @PutMapping("/submitReview/{id}")
    public ResponseBean submitReview(@PathVariable Long id) throws BusinessException {
