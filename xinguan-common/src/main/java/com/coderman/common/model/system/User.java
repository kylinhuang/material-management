...
public class User {
    ...
    @ExcelField(value = "地址 省", width = 100)
    private String province;
    @ExcelField(value = "地址 省 code", width = 100)
    private String provinceValue;


    @ExcelField(value = "地址 市", width = 100)
    private String city;
    @ExcelField(value = "地址 市 code", width = 100)
    private String cityValue;


    @ExcelField(value = "地址 区", width = 100)
    private String origin;
    @ExcelField(value = "地址 区 code", width = 100)
    private String originValue;


    @ExcelField(value = "详细地址", width = 200)
